...
from cortex_backend.api.admin import router as admin_router
from cortex_backend.api.analytics import router as analytics_router
from cortex_backend.api.automation import router as automation_router
from cortex_backend.api.github import router as github_router
from cortex_backend.api.health import router as health_router
from cortex_backend.api.linear import router as linear_router
from cortex_backend.api.pull_requests import router as pr_router
from cortex_backend.api.qa_execution import router as qa_router
from cortex_backend.api.reports import router as reports_router
from cortex_backend.api.webhooks import router as webhooks_router
from cortex_backend.api.ws import router as ws_router
...
async def lifespan(app: FastAPI):
    ...
    try:
        from cortex_backend.database import init_db
        await init_db()
    ...
    if settings.enable_github:
        from cortex_backend.tasks.pr_fetch import scheduled_pr_fetch_loop
...
frontend_dist = Path(__file__).parent.parent / "cortex_frontend" / "dist"
